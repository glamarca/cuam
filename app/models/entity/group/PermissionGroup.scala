...
trait PermissionGroupComponent { this : Profile =>
  ...
  class PermissionsGroups(tag: Tag) extends Table[(PermissionGroup)](tag, "ROLE_GROUP") {
    ...
    override def * = (id.?,permissionId,groupId,added) <>(PermissionGroup.tupled, PermissionGroup.unapply)

  }

}

case class PermissionGroup(id : Option[Int],permissionId : Int,groupId : Int,added : Date)
